...
class Tensor:
    ...
    def __init__(self, data, requires_grad=False, is_leaf=True,
        ...
        self.grad_fn = None # Set during forward pass accumulategrad, or None, backwardfunction
        self.grad = None
    ...
    def backward(self):
        ...
        autograd_engine.backward(self.grad_fn, grad)
    ...
    ''' Here begins my __mul__ '''
    def __mul__(self, other):
        return F.Mul.apply(self, other)
    ''' Here ends my __mul__ '''
    def __sum__(self, axis, keepdims):
        return F.Sum.apply(self, axis, keepdims)
    ''' Here begins my __div__ '''
    def __div__(self, other):
        return F.Div.apply(self, other)
    
    def __truediv__(self, other):
        return F.Div.apply(self, other)
    ''' Here ends my __div__ '''
